...
#   export GITOPS_REPO='git@github.com:mon-org/ecommerce-production-platform.git'
...
if [ -z "${GITOPS_REPO:-}" ]; then
  ...
  echo "  export GITOPS_REPO='git@github.com:org/ecommerce-production-platform.git'"
  exit 1
fi
...
sed "s|git@github.com:YOUR_ORG/ecommerce-production-platform.git|${GITOPS_REPO}|g;
     s|https://github.com/YOUR_ORG/ecommerce-production-platform.git|${GITOPS_REPO}|g" \
